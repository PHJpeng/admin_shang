 ...
 */
class InnerConstraintDataPush extends RpcRequest
{
     ...
     * @var string
     */
    public $action = 'InnerConstraintDataPush';
    ...
    /**
     * @deprecated deprecated since version 2.0, Use withFilePath() instead.
     *
    ...
    public function withFilePath($filePath)
    {
        ...
        $this->options['query']['filePath'] = $filePath;
