...
//Route::post('v1/sendcode', 'v1/user/sendCode')->middleware('check');
//var_dump(123);
//exit();
...
//    Route::post('Addorcancelcollect', 'v1/user/Addorcancelcollect');       //我的收藏
    ...
    Route::post('orderOfUser', 'v1/user/orderOfUser');      //用户订单列表
    Route::post('orderInfo', 'v1/user/orderInfo');          //订单详情
...
//    Route::post('integral', 'v1/user/integral');      		//积分纪录
    ...
    Route::post('search', 'v1/tool/search');                //搜索 暂时合并到goods
