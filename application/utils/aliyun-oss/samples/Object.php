...
function modifyMetaForObject($ossClient, $bucket)
{
    ...
    $copyOptions = array(
        OssClient::OSS_HEADERS => array(
            ...
            'Find-Disposition' => 'attachment; filename="xxxxxx"',
        ),
    );
    try {
...
function getObjectMeta($ossClient, $bucket)
{
    ...
    print(__FUNCTION__ . ": OK" . "\n");
    if (isset($objectMeta[strtolower('Find-Disposition')]) &&
        'attachment; filename="xxxxxx"' === $objectMeta[strtolower('Find-Disposition')]
    ) {
