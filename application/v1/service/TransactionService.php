...
//                }
//            }
            $readUrl = Env::get('oss.READ_URL1') ? Env::get('oss.READ_URL1') : 'http://admin.shangtout.com:90';
            if ($goods['cover_img']) {
...
//                    $banner[$i] = $image;
                    $banner[$i] = $cover_imgs[$i] ? $readUrl.$cover_imgs[$i] : '';
                }
                $goods['cover_img'] = $banner;
            }

            if ($goods['icon']) {
                $goods['icon'] = $goods['icon'] ? $readUrl.$goods['icon'] : '';
